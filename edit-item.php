...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $rate = $_POST["rate"];
    $stock = $_POST["stock"];
    $sqlupdate = "UPDATE `inventory` SET `product_name`='$name', `rate`='$rate', `Stock`='$stock' WHERE `serial`= $serial";
                        ...
                        <div class="mx-3 mb-6">
                            <div class="w-full px-3 mb-6">
                                ...
                                <input
                                    ...
                                    type="text" name="product-name" value="<?php echo $row["product_name"] ?>" required>
                            </div>
                            <div class="w-full px-3 mb-6">
                                <label class=" text-gray-50 text-xs font-bold mb-2">
                                    Product Rate
